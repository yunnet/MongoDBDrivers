...
type
  ...
  public
    ...
    function ReadObjectId: AnsiString;
...
function TBSONStream.ReadCString: AnsiString;
var
  c: AnsiChar;
  s: AnsiString;
...
function TBSONStream.ReadUTF8String: AnsiString;
var
  vLength: Integer;
...
function TBSONStream.ReadObjectId: AnsiString;
const
