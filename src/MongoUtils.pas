...
type
  ...
  public
    ...
    class function NewGuidAsString: AnsiString; overload;
    class function TryStringToGuid(value: AnsiString; var GUID: TGUID): Boolean;
  end;

implementation

uses
  SysUtils, StrUtils, ComObj;
...
class function TGUIDUtils.NewGuidAsString: AnsiString;
begin
  Result := GuidToString(NewGuid);
end;

class function TGUIDUtils.TryStringToGuid(value: AnsiString; var GUID: TGUID): Boolean;
begin
