...
type
  ...
  public
    ...
    constructor Create(ACode: Integer; const Msg: AnsiString);overload;
...
constructor EMongoException.Create(ACode: Integer; const Msg: AnsiString);
begin
  inherited Create(Msg);
  FCode := ACode;
end;

constructor EMongoException.Create(const Msg: AnsiString);
begin
  inherited Create(Msg);
end;
